...
const EXPECTED_COLUMNS = {
  ...
  barangays: { risk_level: `TEXT DEFAULT 'Low'`, flood_susceptibility: `TEXT DEFAULT 'Low'`, landslide_susceptibility: `TEXT DEFAULT 'Low'`, population: `INTEGER DEFAULT 0`, boundary_geojson: `TEXT`, created_at: `TEXT`, updated_at: `TEXT`, captain_name: `TEXT`, contact_number: `TEXT`, flood_area_geojson: `TEXT`, landslide_area_geojson: `TEXT` },
