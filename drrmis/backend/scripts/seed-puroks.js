...
const PUROK_DATA = {
  ...
  'Bagubad': ['Bofal', 'Camingawan', 'Cantol', 'Kidisin'],
  ...
  'Kibuging': ['Kabularan', 'Kahulogan', 'Ki-iwang'],
  ...
  'Libertad': ['Dinaut', 'Langguyod', 'Linait', 'Mahayag', 'Tigbaw'],
  ...
  'Mimbunga': ['Elizolde', 'Kausbawan', 'Luan', 'Panapi-an'],
  ...
  'Odiongan': ['Amontay', 'Calaanan', 'Dulag', 'Kalapyahan', 'Mag-ubay-ubay', 'Minbaca', 'Pandacawan', 'Pandacdacan', 'Pagtabucan', 'Pagtalinan', 'Tabique'],
