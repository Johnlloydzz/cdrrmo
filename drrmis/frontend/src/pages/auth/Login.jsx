      ...
      <div className="flex-1 bg-gray-50 flex items-center justify-center p-3 overflow-y-auto">
        <div className="w-full max-w-sm">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-5">
            ...
            {error && (
              <div className="mt-2 p-2 bg-red-50 border border-red-200 rounded-lg text-xs text-red-700 flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        value={form.password}
                        onChange={handle}
                        className="input pl-8 pr-9 py-1.5 text-sm"
