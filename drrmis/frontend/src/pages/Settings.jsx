    ...
    <div className="max-w-3xl space-y-6">
      ...
      <Section title="System Information" icon={Database}>
        <div className="grid grid-cols-2 gap-4">
          <div className="col-span-2"><label className="label">System Name</label><input className="input" value={system.name} onChange={e => setSystem({...system,name:e.target.value})} /></div>
          <div><label className="label">Address</label><input className="input" value={system.address} onChange={e => setSystem({...system,address:e.target.value})} /></div>
          <div><label className="label">Contact Number</label><input className="input" value={system.contact} onChange={e => setSystem({...system,contact:e.target.value})} /></div>
          <div className="col-span-2"><label className="label">Email</label><input className="input" type="email" value={system.email} onChange={e => setSystem({...system,email:e.target.value})} /></div>
        </div>
      </Section>
